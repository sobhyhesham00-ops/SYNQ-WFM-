...
export default function App() {
  const [token, setToken] = useState<string | null>(() => localStorage.getItem('tayar_token'));
  const [name, setName] = useState(() => localStorage.getItem('tayar_name') ?? '');
  ...
  function onLogin(t: string, n: string) {
    localStorage.setItem('tayar_token', t);
    localStorage.setItem('tayar_name', n);
    ...
    <div className="app">
      ...
      <aside className="sidebar">
        <div className="brandbar">
          <div className="brand"><span className="brand-dot" /> Tayar</div>
