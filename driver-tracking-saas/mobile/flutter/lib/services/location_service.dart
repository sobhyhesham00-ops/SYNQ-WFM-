...
const _wsBase = String.fromEnvironment('WS_BASE', defaultValue: 'wss://api.tayar.app');
...
Future<void> initBackgroundTracking() async {
  ...
  await service.configure(
    androidConfiguration: AndroidConfiguration(
      ...
      notificationChannelId: 'tayar_tracking',
      initialNotificationTitle: 'Tayar — أنت متصل',
