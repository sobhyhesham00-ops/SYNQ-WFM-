          ...
          children: [
            Row(
              ...
              children: [
                Row(children: [
                  ...
                  const Text('Tayar', style: TextStyle(fontWeight: FontWeight.w800, fontSize: 20)),
                ]),
                CircleAvatar(backgroundColor: Colors.white,
                  child: Text(widget.driverName.characters.first,
                    style: const TextStyle(color: TayarColors.brand, fontWeight: FontWeight.w700))),
              ],
            ),
            ...
            Container(
              ...
              decoration: BoxDecoration(
                gradient: TayarColors.brandGradient,
            ...
            FilledButton(
              style: FilledButton.styleFrom(
                backgroundColor: _onShift ? TayarColors.danger : null,
              ),
              onPressed: () async {
            ...
            if (_onShift)
              Padding(
                ...
                child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                  const Icon(Icons.circle, color: TayarColors.ok, size: 10),
                  const SizedBox(width: 6),
                  Text('Location sharing on', style: TextStyle(color: TayarColors.muted, fontSize: 12)),
                ]),
              ),
                ...
                child: Row(children: [
                  Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    ...
                    Text('${o.$2.toStringAsFixed(0)} EGP',
                      style: const TextStyle(color: TayarColors.muted, fontSize: 13)),
                  ])),
                  _StatusChip(o.$3),
                ]),
              ),
...
class _StatusChip extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final fg = status == 'Delivered' ? TayarColors.ok
        : status == 'PickedUp' ? TayarColors.brand : TayarColors.danger;
    return Container(
