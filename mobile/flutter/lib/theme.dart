...
ThemeData buildMeshwarTheme() {
  return ThemeData(
    useMaterial3: true,
    scaffoldBackgroundColor: MeshwarColors.bg,
    colorScheme: ColorScheme.fromSeed(seedColor: MeshwarColors.brand),
    fontFamily: 'Inter',
    textTheme: const TextTheme(
      titleLarge: TextStyle(fontWeight: FontWeight.w800, color: MeshwarColors.ink),
      bodyMedium: TextStyle(color: MeshwarColors.ink),
    ),
    filledButtonTheme: FilledButtonThemeData(
      style: FilledButton.styleFrom(
        backgroundColor: MeshwarColors.brand,
...
class MeshwarCard extends StatelessWidget {
  const MeshwarCard({super.key, required this.child, this.padding});
  final Widget child;
