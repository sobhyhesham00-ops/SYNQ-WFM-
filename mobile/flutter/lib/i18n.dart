...
const Map<String, Map<String, String>> _dict = {
  'en': {
    ...
    'serverSettings': 'Backend server',
    'serverUrl': 'Server URL',
    'serverHint': 'Paste the backend URL (e.g. your Codespace https:// link).',
    'save': 'Save',
    'cancel': 'Cancel',
  ...
  'ar': {
    ...
    'st.Failed': 'فشل',
    'st.Cancelled': 'اتلغى',
    'serverSettings': 'سيرفر البرنامج',
    'serverUrl': 'رابط السيرفر',
    'serverHint': 'الصق رابط الباك إند (زي لينك الـ Codespace بتاعك).',
    'save': 'حفظ',
    'cancel': 'إلغاء',
