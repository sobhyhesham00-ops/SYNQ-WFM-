...
const en: Dict = {
  ...
  waCustomer: 'WhatsApp',
  waMessage: 'Your order from {biz} is on the way with {driver} 🛵 Track it live here: {url}',
  cancelOrder: 'Cancel',
  cancelConfirm: 'Cancel this order? This frees the driver if it was assigned.',
  edit: 'Edit',
  save: 'Save',
  cancel: 'Cancel',
  ...
  desktopAlertsHint: 'Sound + a notification when a delivery fails, even in the background.',
  enableAlerts: 'Enable',
  alertsOn: 'Enabled ✓',
  alertsBlocked: 'Blocked in your browser',
  businessProfile: 'Business profile',
  businessPhone: 'Business phone',
  saved: 'Saved',
  shopLocation: 'Shop location',
  shopLocationHint: 'Used to rank drivers by distance when assigning orders.',
  ...
  deleteBusinessHint: 'Permanently deletes your business, all drivers, orders, cash records and location history. This cannot be undone.',
  deleteConfirmPassword: 'Enter your password to confirm',
  deleteConfirmTitle: 'Delete this business?',
  deleteForever: 'Delete forever',
  wrongPassword: 'Wrong password',
  geoUnavailable: 'Location is not available on this device.',
  geoDenied: "Couldn't get your location — allow location access and retry.",
  revenueTitle: 'Revenue',
  lastNDays: 'Last {n} days · collected',
  noRevenueYet: 'No delivered revenue yet',
  deliveriesN: '{n} deliveries',
  failedToast: '❌ Delivery failed — {addr}',
  staleToast: '⏳ Waiting too long — {addr}',
  attentionSummary: '⚠️ {n} orders need attention',
  attention: 'Needs attention',
  failedDeliveries: 'Failed deliveries',
  stalePending: 'Waiting too long (unassigned)',
  staleAssigned: 'Assigned, not picked up',
  allClear: 'All clear — nothing needs attention 🎉',
  history: 'Order history',
  searchOrders: 'Search address or phone…',
  exportDrivers: 'Driver report',
  ...
  deactivateConfirm: 'Deactivate this driver? They will be logged out and unable to sign in.',
  resetPin: 'Reset PIN',
  newPin: 'New PIN for this driver (min 4 digits):',
  pinReset: 'PIN reset. Give the driver their new PIN.',
  ...
  step3Location: 'Set your shop location (for nearest-driver assignment)',
  ...
  sumDeliveries: 'Deliveries',
  sumOpen: 'Open orders',
  sumCollected: 'Cash collected',
  sumOutstanding: 'With drivers (owed)',
  sumDrivers: 'Drivers active',
...
const ar: Dict = {
  ...
  assignTo: 'اختار سواق…',
  reassignTo: 'غيّر السواق…',
  shareTracking: 'ابعت رابط التتبع',
  waCustomer: 'واتساب',
  waMessage: 'طلبك من {biz} في الطريق مع {driver} 🛵 تابعه لايف من هنا: {url}',
  cancelOrder: 'إلغاء',
  cancelConfirm: 'تلغي الطلب ده؟ لو كان متوزّع هيفضّي السواق.',
  edit: 'تعديل',
  save: 'حفظ',
  cancel: 'إلغاء',
  phone: 'تليفون العميل',
  ...
  desktopAlertsHint: 'صوت + إشعار لما توصيلة تفشل، حتى لو الصفحة في الخلفية.',
  enableAlerts: 'تفعيل',
  alertsOn: 'مفعّل ✓',
  alertsBlocked: 'محظور في المتصفح',
  businessProfile: 'بيانات المحل',
  businessPhone: 'تليفون المحل',
  saved: 'اتحفظ',
  shopLocation: 'موقع المحل',
  shopLocationHint: 'بيُستخدم عشان يرتّب السواقين بالأقرب وقت التوزيع.',
  locationNotSet: 'مش متحدد',
  useCurrentLocation: 'استخدم موقعي الحالي',
  clearLocation: 'مسح',
  serverUnreachable: 'مش قادر يوصل للسيرفر — بيحاول تاني…',
  reconnecting: 'بيعيد الاتصال بالتحديثات المباشرة…',
  dangerZone: 'منطقة الخطر',
  deleteBusiness: 'حذف المحل',
  deleteBusinessHint: 'بيمسح محلك وكل السواقين والطلبات وسجلات الكاش والمواقع نهائياً. مفيش رجوع.',
  deleteConfirmPassword: 'اكتب رقمك السري للتأكيد',
  deleteConfirmTitle: 'تحذف المحل ده؟',
  deleteForever: 'احذف نهائياً',
  wrongPassword: 'الرقم السري غلط',
  geoUnavailable: 'الموقع مش متاح على الجهاز ده.',
  geoDenied: 'معرفناش نجيب موقعك — اسمح بالوصول للموقع وحاول تاني.',
  revenueTitle: 'الإيراد',
  lastNDays: 'آخر {n} يوم · اتحصّل',
  noRevenueYet: 'لسه مفيش إيراد',
  deliveriesN: '{n} توصيلة',
  failedToast: '❌ التوصيل فشل — {addr}',
  staleToast: '⏳ مستني من زمان — {addr}',
  attentionSummary: '⚠️ {n} طلبات محتاجة انتباه',
  attention: 'محتاج انتباه',
  failedDeliveries: 'توصيلات فشلت',
  stalePending: 'مستنية من زمان (مش متوزّعة)',
  staleAssigned: 'اتوزّعت وماستلمهاش السواق',
  allClear: 'كله تمام — مفيش حاجة محتاجة انتباه 🎉',
  history: 'سجل الطلبات',
  searchOrders: 'دوّر بالعنوان أو التليفون…',
  exportDrivers: 'تقرير السواقين',
  allStatuses: 'كل الحالات',
  allDrivers: 'كل السواقين',
  fromDate: 'من',
  toDate: 'إلى',
  prev: 'السابق',
  next: 'التالي',
  noResults: 'مفيش طلبات بالفلاتر دي',
  showingCount: 'بيعرض {n} من {total}',
  inactive: 'موقوف',
  deactivate: 'إيقاف',
  reactivate: 'تفعيل',
  deactivateConfirm: 'توقف السواق ده؟ هيتسجّل خروجه ومش هيقدر يدخل تاني.',
  resetPin: 'تغيير الكود',
  newPin: 'كود سري جديد للسواق (٤ أرقام على الأقل):',
  pinReset: 'اتغيّر الكود. إدّي السواق الكود الجديد.',
  ...
  step3Location: 'حدّد موقع محلك (عشان توزيع الأقرب)',
  setLocation: 'حدّد الموقع',
  ...
  dailySummary: 'ملخص النهاردة',
  sumDeliveries: 'التوصيلات',
  sumOpen: 'طلبات مفتوحة',
  sumCollected: 'الكاش المُحصّل',
  sumOutstanding: 'مع السواقين (مستحق)',
  sumDrivers: 'سواقين شغالين',
  shareWhatsapp: 'ابعت على واتساب',
  copied: 'اتنسخ',
